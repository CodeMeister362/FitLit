...
describe('Hydration Class', () => {
  ...
  it('should return the average ounces drank for a given user', () => {
    assert.equal(waterData.averageOuncesPerDay( 1), 24)
  });

  it('should return the amount drank based on specific day', () => {
    assert.equal(waterData.getSpecificDay( 2, "2023/03/24"), 35)
  });

  it('should return the amount of water drank each day over a week', () => {
